...
$mod_title      = 'Image Award';
$mod_version    = '1.0.4';
$release_date   = '2012-11-15';
$author         = 'Spiky and Frank Hagstrom for original Image Award Mod 1.0.0 version';
...
function install()
{
    ...
    $db->add_field('users', 'imgaward', 'VARCHAR(255)', false, '', 'activate_key') or error('Unable to add column "imgaward" to table "users"', __FILE__, __LINE__, $db->error());
}
...
function restore()
{
    ...
    $db->drop_field('users', 'imgaward') or error('Unable to drop column "imgaward" from table "users"', __FILE__, __LINE__, $db->error());
}
	...
	<div class="box">
		<form method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>?foo=bar">
			...
			<div class="inform">
				...
				<p><strong>Release date:</strong> <?php echo pun_htmlspecialchars($release_date) ?></p>
